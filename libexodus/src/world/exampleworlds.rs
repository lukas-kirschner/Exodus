...
impl GameWorld {
    ...
    pub fn exampleworld() -> Self {
        ...
        world
            ...
            .set_author("World containing all tiles")
            .set(2, 1, WALL)
            .set(1, 1, WALL)
            .set(1, 2, PLAYERSPAWN)
            .set(3, 1, SPIKES)
            ...
            .set(5,3,TELEPORTENTRY { teleport_id: TeleportId::THREE })
            .set(4, 3, WALLCOBBLE)
            ...
            .set(3, 7, WALLNATURE)
            .set(4, 7, WALLNATURE)
            .set(4,6,TELEPORTENTRY { teleport_id: TeleportId::FOUR })
            .set(4, 8, DOOR)
            .set_message_tile(3, 8, "Collect the key to open the door.".into())
            .set(6, 3, WALLSMOOTH)
            .set(7, 7, WALLNATURE)
            .set(8,8,TELEPORTEXIT { teleport_id: TeleportId::THREE })
            .set(8, 7, LADDERNATURE)
            .set(8, 6, LADDER)
            .set(9, 7, WALLNATURE)
            .set(10, 7, WALL)
            .set(11,8,TELEPORTEXIT { teleport_id: TeleportId::FOUR })
            ...
            .set(12,2,TELEPORTEXIT { teleport_id: TeleportId::ONE })
            .set(12, 1, WALLSPIKESL)
            .set(14,2,TELEPORTEXIT { teleport_id: TeleportId::TWO })
            ...
            .set(22,1,TELEPORTENTRY { teleport_id: TeleportId::ONE })
            .set(21,1,TELEPORTENTRY { teleport_id: TeleportId::TWO })
            .set(20, 0, WALLCHISELED)
            .set(19, 0, SLOPE)
            .set(18, 0, SLOPE)
            .set(17, 0, WALLCHISELED)
            .set(17, 7, COIN)
            .set(19, 1, ARROWDOWN)
            .set(18, 1, ARROWLEFT)
            .set(17, 1, ARROWRIGHT)
